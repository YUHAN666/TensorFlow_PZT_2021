...
def bifpn_neck(features, num_channels, momentum, mode, data_format, is_training=False, reuse=None):
...
def fpn_neck(feature, class_num, drop_rate, keep_dropout_head, TOP_DOWN_PYRAMID_SIZE=128, training=True, reuse=None):
    C5 = feature[4]
    C4 = feature[3]
    C3 = feature[2]
    C2 = feature[1]
