...
def CSPPeleeNet(inputs, data_format, drop_rate, training, momentum, name, pelee_cfg=pelee_cfg, mode=None,
                activation='relu'):
    with tf.variable_scope(name, reuse=False):
        ...
        x = CBR(x, 128, 1, 1, training=training, momentum=momentum, name="mix_conv", data_format=data_format,
